...
(function (global, factory) {
   ...
   *
   * @param {Object} packet - controllers event packet
  ...
  /**
   * A controllers Encoder instance
   */
  ...
  /**
   * A controllers Decoder instance
   *
  ...
  var Manager = /*#__PURE__*/function (_Emitter) {
    ...
    function Manager(uri, opts) {
      ...
      opts = opts || {};
      opts.path = opts.path || "/controllers";
      _this.opts = opts;
      installTimerFunctions(_assertThisInitialized(_this), opts);
  ...
  function lookup(uri, opts) {
    ...
    opts = opts || {};
    var parsed = url(uri, opts.path || "/controllers");
